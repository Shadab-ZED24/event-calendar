		...
		<CalendarProvider value={{ selectMonth, selectDay }}>
			<div className="sc-wrapper">
				<div className="sc-year-wrapper">
					<div onClick={() => changeView('day', selectedDate.value, false, true)}
							className={`spring-button ${selectedDate.type === 'day' ? 'spring-button-active' : ''}`}>
						<a href="#"><span title="Add Event"><b><u>+ADD</u></b></span></a>
					</div>
					<div onClick={() => changeView('day', selectedDate.value, false, true)}
							className={`spring-button ${selectedDate.type === 'day' ? 'spring-button-active' : ''}`}>
						<b><u>Today Plans</u></b>
					</div> 
					<div onClick={() => changeView('year', selectedDate.value, false, true)}
